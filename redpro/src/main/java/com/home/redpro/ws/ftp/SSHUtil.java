...
public class SSHUtil {
	...
	public static class DestHost {
	 ...
	 public static void main(String[] args) throws JSchException, IOException {  
	        ...
	        SSHUtil.DestHost host = new SSHUtil.DestHost("172.16.22.150", "orchestration", "orchestration");
	        
			String stdout = "";

			Session shellSession = SSHUtil.getJSchSession(host);
			stdout = SSHUtil.execCommandByJSch(shellSession, "mkdir test/2019000");
			System.out.println(stdout);
			stdout = SSHUtil.execCommandByJSch(shellSession, "pwd");
			System.out.println(stdout);
