...
/**
 * 文件上传组件 基于jquery-file-upload<br>
 */
    ...
    $.widget('blueimp.fileupload', $.blueimp.fileupload, {
        ...
        options: {
            ...
            */
            ...
            // Error and info messages:
            messages: {
                maxNumberOfFiles: fish.getResource('fileupload.maxNumberOfFiles'), //'Maximum number of files exceeded',
                acceptFileTypes: fish.getResource('fileupload.acceptFileTypes'),//'File type not allowed',
                maxFileSize: fish.getResource('fileupload.maxFileSize'),//'File is too large',
                minFileSize: fish.getResource('fileupload.minFileSize')//'File is too small'
            }
        },
